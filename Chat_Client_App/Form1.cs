    ...
    public partial class Form1 : Form
    {
        ...
        private void MessageCallBack(IAsyncResult aResult)
        {
            try
            {
                ...
                if (size > 0)
                {
                    ...
                    string customMessage = customDecryption(receivedMessage.ToCharArray());
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string customMessage = customEncryption(sMsg.ToCharArray());
        ...
        public static string customEncryption(char []s)
        {
            int l = s.Length;
        ...
        public static string customDecryption(char []s)
        {
            int l = 15;
            int b = (int)Math.Ceiling(Math.Sqrt(l));
            int a = (int)Math.Floor(Math.Sqrt(l));
